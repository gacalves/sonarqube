...
public class DuplicationLineReader implements LineReader {
  ...
  private void sortDuplication(){
    // Sort duplication to have deterministic results and avoid false variation that would lead to an unnecessary update of the source files data
    Collections.sort(this.duplications, new Comparator<BatchReport.Duplication>() {
      @Override
