...
public class SymbolsLineReader implements LineReader {
  ...
  private void sortSymbols() {
    // Sort symbols to have deterministic results and avoid false variation that would lead to an unnecessary update of the source files data
    Collections.sort(this.symbols, new Comparator<BatchReport.Symbols.Symbol>() {
      @Override
